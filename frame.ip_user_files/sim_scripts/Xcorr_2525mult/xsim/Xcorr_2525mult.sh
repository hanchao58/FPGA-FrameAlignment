...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_16 -L xil_defaultlib -L secureip -L xpm --snapshot Xcorr_2525mult xil_defaultlib.Xcorr_2525mult -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Xcorr_2525mult -key {Behavioral:sim_1:Functional:Xcorr_2525mult} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Xcorr_2525mult.wdb xsim.dir)
