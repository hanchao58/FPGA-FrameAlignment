...
#
# Generated by Vivado on Thu Mar 31 16:44:37 +0800 2022
# SW Build 2708876 on Wed Nov  6 21:40:23 MST 2019
#
# Copyright 1986-2019 Xilinx, Inc. All Rights Reserved. 
#
# usage: Cmult_xcorr.sh [-help]
# usage: Cmult_xcorr.sh [-lib_map_path]
# usage: Cmult_xcorr.sh [-noclean_files]
# usage: Cmult_xcorr.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "Cmult_xcorr.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_16 -L cmpy_v6_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot Cmult_xcorr xil_defaultlib.Cmult_xcorr -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Cmult_xcorr -key {Behavioral:sim_1:Functional:Cmult_xcorr} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./Cmult_xcorr.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Cmult_xcorr.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./Cmult_xcorr.sh -help\" for more information)\n"
    exit 1
  fi
