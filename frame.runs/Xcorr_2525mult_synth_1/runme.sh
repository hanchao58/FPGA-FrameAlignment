...
HD_PWD='D:/Projects/frame/frame.runs/Xcorr_2525mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Xcorr_2525mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Xcorr_2525mult.tcl
