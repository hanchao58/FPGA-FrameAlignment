...
HD_PWD='D:/Projects/frame/frame.runs/Track_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Track_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Track_ram.tcl
