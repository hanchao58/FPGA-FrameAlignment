...
HD_PWD='D:/Projects/frame/frame.runs/Cmult_xcorr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cmult_xcorr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cmult_xcorr.tcl
