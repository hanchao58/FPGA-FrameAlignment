...
HD_PWD='D:/Projects/frame/frame.runs/Xcorr_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Xcorr_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Xcorr_ram.tcl
